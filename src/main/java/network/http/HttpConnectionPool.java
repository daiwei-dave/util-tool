...
public class HttpConnectionPool {
    ...
    public static CloseableHttpClient getHttpClient(String url) {
        ...
        if (httpClient == null) {
            synchronized (syncLock) {
                if (httpClient == null) {
                    httpClient = createHttpClient(40, 10, 8, hostname, port);
                }
            }
        }
        return httpClient;
    ...
    public static String postJson(String url, String jsonStr) throws IOException {
        ...
        try {
            ...
            logger.error("postJson Err URL:" + url + "Josn:" + jsonStr);
    ...
    public static void main(String[] args) {
        // URL列表数组
        String[] urisToGet = { "http://ehm.gome.work/ygzz/login/mainpage.jsp?from=sso_login_success",
                "http://ehm.gome.work/ygzz/login/mainpage.jsp?from=sso_login_success",
                "http://ehm.gome.work/ygzz/login/mainpage.jsp?from=sso_login_success",
                "http://ehm.gome.work/ygzz/login/mainpage.jsp?from=sso_login_success",
                "http://ehm.gome.work/ygzz/login/mainpage.jsp?from=sso_login_success",
                "http://ehm.gome.work/ygzz/login/mainpage.jsp?from=sso_login_success",
    ...
    static class GetRunnable implements Runnable {
        ...
        public void run() {
            try {
                System.out.println(HttpConnectionPool.get(url));
            } finally {
